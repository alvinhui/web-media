...
[线上示例](https://codesandbox.io/s/github/alvinhui/100-Days-Of-WebMedia/tree/main/zh-cn/02_capture/01_task_photo/02_imageCapture)

## 使用的 API

- [MediaDevices.getUserMedia()](https://developer.mozilla.org/zh-CN/docs/Web/API/MediaDevices/getUserMedia)
- [ImageCapture](https://developer.mozilla.org/zh-CN/docs/Web/API/ImageCapture)
...
- [MediaStream Image Capture API](https://developer.mozilla.org/zh-CN/docs/Web/API/MediaStream_Image_Capture_API)
