...
- [MDN](./MDN.md)：MDN Web Docs 是一个免费提供 Web 技术学习的平台，收藏夹中包含了如何通过 MDN 学习 Web 技术的指引，并提供了 MDN 中多媒体相关的内容列表。
- [W3C](./W3C.md)：World Wide Web Consortium(万维网联盟)，又称 W3C 理事会，是万维网的主要国际标准组织，收藏夹中包含了如何通过 W3C 学习 Web 技术的指引，并提供了 W3C 中多媒体相关的内容列表。
